...
const RegModel = require('./model/reg.js')
const cors = require('cors')
const mongoose = require('mongoose')
const UsrModel =require('./model/user.js')
...
mongoose.connect("mongodb+srv://vishnuvm10101:123@cluster0.mksfrxv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
.then(()=>{
